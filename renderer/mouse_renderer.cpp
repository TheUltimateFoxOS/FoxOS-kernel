...
void MouseRenderer::on_mouse_move(uint8_t mouse_packet[4]) {
	...
	global_renderer2D->clear_mouse_cursor(MousePointer, mouse_position_old);
	global_renderer2D->draw_overlay_mouse_cursor(MousePointer, mouse_position, 0xffffffff);
