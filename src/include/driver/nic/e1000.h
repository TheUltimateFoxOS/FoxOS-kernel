...
namespace driver{
	class e1000Driver: public Driver, public interrupts::InterruptHandler, public nic::Nic {
		public:
			e1000Driver(pci::pci_header_0_t* header, uint16_t bus, uint16_t device, uint16_t function);
			~e1000Driver();
